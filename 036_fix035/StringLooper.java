...
public class StringLooper {
    ...
    public static int indexOfSubstring( String seek, String within) {
        ...
        while( withinPos < within.length() - seek.length() + 1) {
            if (isFullMatch(seek,within, withinPos)) {
                return withinPos;
            }
            ++withinPos;
        }
    ...
    /**
       isFullMatch
       @return the boolean comparing each character in "seek" to the corresponding character in "within"
     */
    private static boolean isFullMatch( String seek
                                      , String within
                                      , int withinPos
                                      ) {
        int seekPos = 0;
