...
public class UserOfToH {
    ...
    public static void main( String[] commandLine) {
        ...
        //sum counting through tests
        System.out.println(ToH.sumCountingThrough(1)); // 55
        System.out.println(ToH.sumCountingThrough(10)); // 5050
        System.out.println(ToH.sumCountingThrough(100)); // 1
    }
